...
func (pnc *PodNetworksController) processNextWorkItem() bool {
	...
	networkSelectionElements, _ := annotations.PodNetworkSelectionElements(pod) // ignore error as other functions below?
	networkStatus, _ := annotations.PodDynamicNetworkStatus(pod)
