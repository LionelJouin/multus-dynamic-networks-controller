...
func (pnc *PodNetworksController) processNextWorkItem() bool {
	...
	networkSelectionElements := annotations.PodNetworkSelectionElements(pod)
	networkStatus, _ := annotations.PodDynamicNetworkStatus(pod) // ignore error as other functions below?
